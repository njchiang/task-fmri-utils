function [smm_rs, smm_ps, n] = searchlightMapping_SVM(fullBrainVolumes, models, mask, runs, userOptions, localOptions)
...
mappingMask_actual(isnan(sum(vec_rs,4)))=0;

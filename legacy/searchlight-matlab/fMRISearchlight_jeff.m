function [varargout] = fMRISearchlight_jeff(fullBrainVols, binaryMasks_nS, models, betaCorrespondence, userOptions)
%
...
userOptions= setIfUnset(userOptions, 'saveRDMs', 1)
% The analysisName will be used to label the files which are eventually saved.
mapsFilename = [userOptions.analysisName,'_', userOptions.analysisType '_fMRISearchlight_Maps.mat'];
RDMsFilename = [userOptions.analysisName,'_', userOptions.analysisType '_fMRISearchlight_RDMs.mat'];
DetailsFilename = [userOptions.analysisName,'_', userOptions.analysisType '_fMRISearchlight_Details.mat'];
...
if overwriteFlag
    ...
    for subjectNumber = 1:nSubjects % and for each subject...
        ...
        for maskNumber = 1:nMasks % For each mask...
            ...
            nMapMetadataStruct_nS.fname = fullfile(userOptions.rootPath, ['Maps/' userOptions.analysisType], [userOptions.analysisName '_nMap_' maskName '_' subject '.img']);
            ...
            for modelNumber = 1:numel(models)
                ...
                rMapMetadataStruct_nS.fname = fullfile(userOptions.rootPath, ['Maps/' userOptions.analysisType], [userOptions.analysisName '_rMap_' maskName '_' modelName '_' subject '.img']);
